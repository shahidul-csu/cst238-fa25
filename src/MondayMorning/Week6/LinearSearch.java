...
//        Random rand = new Random();
        ...
        do{
            ...
            ArrayList<Integer> al1 = searchAllIndex(data, num);
            System.out.println("The locations for " + num + ": " + al1);
        }while(num > 0);
    }

    public static ArrayList<Integer> searchAllIndex(int[] data, int key){
//        ArrayList<int> al; //X Generics cannot accept primitive datatype
//        ArrayList<String> as = new ArrayList<>();
    ...
    public static int searchIndexRev(int[] data, int key){
    ...
    public static int searchIndex(int[] data, int key){
        for(int i = 0; i < data.length; i++){
            if(data[i] == key){
                return i;
            }
